resource "aws_kinesis_stream" "foo_stream" {
  ...
  # SaC Testing - Severity: High - Set retention_period to 50
  #retention_period          =     # Must be configured
  # SaC Testing - Severity: High - Set encryption_type to "" 
  encryption_type           = "" # Must be configured # Preferred value KMS
